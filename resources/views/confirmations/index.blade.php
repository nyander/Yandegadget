        ...
        <div id="createproduct" class="container">
            ...
            <form action="{{route('confirmations.store')}}" method="POST" onsubmit="myButton.disabled = true; return true;">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="date" max="{{$today}}" name="shipmentdate" placeholder="Enter Date of Purchase"> 
                    </div>
                </div>  
                ...
                @foreach (Cart::content() as $item)
                    <div class="confirmation-table-row">
                        ...
                        <div class="confirmation-product-details">
                            <div class="shipment-table-item"> <a href="/products/{{$item->id}}">
                                {{$item->model->name}}</a>
                            </div>
                            <div class="shipment-table-conditionnotes">
                                {{$item->model->condition_Notes}}
                            </div>
